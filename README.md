...
The following setion assumes that you already have `git`, `curl`, `unxz`, `python`, `pip`, `adb`, `sdkmanager`, `avdmanager`, and `npm` installed and on your PATH.
